    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('summary', models.TextField(help_text='Book description', max_length=100)),
                ('isbn', models.CharField(help_text='The ISBN contains 13 characters', max_length=13, verbose_name='ISBN')),
